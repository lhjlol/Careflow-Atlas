...
export interface ImportReview { fileName: string; issues: ImportIssueView[]; counts: Record<string, number>; canReplace: boolean; preview?: Array<{ label: string; detail: string }>; changes?: { added: number; updated: number; duplicates: number; retained: number }; }
...
export function ImportDialog({ open, review, loading = false, error, notice, onClose, onFile, onLoadSample, onDownloadSample, onLoadDistrict, onDownloadDistrict, onConfirmReplace, onExport, onBackup, onPrint, onRetry }: ImportDialogProps) {
